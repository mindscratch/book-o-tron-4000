...
@Entity
@Table(name="COMMENT")
public class Comment extends AbstractEntity implements IComment {
    private IUser user;
    ...
    @ManyToOne(targetEntity = Review.class, cascade = {CascadeType.PERSIST, CascadeType.MERGE, CascadeType.REFRESH})
